...
<form:form method="post" modelAttribute="measurement">
    ...
    Masa ciała: <form:input path="bodyWeight"/><br>
    ...
    Poziom tkanki tłuszczowej wisceralnej: <form:input path="visceralFat"/><br>

    <form:errors path="muscleMass" cssClass="error"/><br>
    Masa mięśniowa: <form:input path="muscleMass"/><br>
    ...
    Poziom mineralny kości: <form:input path="boneMass"/><br>

    <form:errors path="BMI" cssClass="error"/><br>
    BMI: <form:input path="BMI"/><br>

    <form:errors path="metabolicAge" cssClass="error"/><br>
    Wiek metaboliczny: <form:input path="metabolicAge"/><br>

    <form:errors path="basalMetabolicRate" cssClass="error"/><br>
    Podstawowa przemiana materii: <form:input path="basalMetabolicRate"/><br>
